...
- **BREAKING** Replace the production FastAPI/PostgreSQL public site with a pre-generated static site deployed by GitHub Pages at the custom domain `https://scotusbriefs.us/`; no production page may require a server, database, object store, or runtime secret.
